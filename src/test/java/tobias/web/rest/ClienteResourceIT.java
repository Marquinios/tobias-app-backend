...
class ClienteResourceIT {
    ...
    private static final Integer DEFAULT_NRO_CELULAR = 1;
    private static final Integer UPDATED_NRO_CELULAR = 2;
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getNroCelular()).isEqualTo(DEFAULT_NRO_CELULAR);
    }
    ...
    void putExistingCliente() throws Exception {
        ...
        assertThat(testCliente.getNroCelular()).isEqualTo(UPDATED_NRO_CELULAR);
    }
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.apellido(UPDATED_APELLIDO);
