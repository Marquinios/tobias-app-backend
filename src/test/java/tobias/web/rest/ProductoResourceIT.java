...
class ProductoResourceIT {
    ...
    public static Producto createEntity(EntityManager em) {
        Producto producto = new Producto().nombre(DEFAULT_NOMBRE).precio(DEFAULT_PRECIO).imagenUrl(DEFAULT_IMAGEN_URL);
        return producto;
    }
    ...
    public static Producto createUpdatedEntity(EntityManager em) {
        Producto producto = new Producto().nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO).imagenUrl(UPDATED_IMAGEN_URL);
        return producto;
    }
    ...
    void createProducto() throws Exception {
        ...
        assertThat(testProducto.getImagenUrl()).isEqualTo(DEFAULT_IMAGEN_URL);
    }
    ...
    void putExistingProducto() throws Exception {
        ...
        updatedProducto.nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO).imagenUrl(UPDATED_IMAGEN_URL);
        ...
        assertThat(testProducto.getImagenUrl()).isEqualTo(UPDATED_IMAGEN_URL);
    }
    ...
    void fullUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO).imagenUrl(UPDATED_IMAGEN_URL);
