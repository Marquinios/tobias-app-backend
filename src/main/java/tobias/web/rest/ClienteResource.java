...
/**
 * REST controller for managing {@link tobias.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
public class ClienteResource {
     ...
     */
    @GetMapping("/clientes")
    public ResponseEntity<Page<Cliente>> getAllClientes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
