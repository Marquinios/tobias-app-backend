...
/**
 * REST controller for managing {@link tobias.domain.Venta}.
 */
@RestController
@RequestMapping("/api")
public class VentaResource {
    ...
    public ResponseEntity<Venta> updateVenta(@PathVariable(value = "id", required = false) final Long id, @RequestBody Venta venta)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, venta.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Venta> partialUpdateVenta(@PathVariable(value = "id", required = false) final Long id, @RequestBody Venta venta)
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, venta.getId().toString())
        );
    }
